...
class OrderNotificationPreferenceIntegrationTests(APITestCase):
    ...
    def setUp(self):
        self.admin_user = self.create_test_user(
            phone="+989820000001",
            email="admin_order_pref@example.com",
            full_name="Order Preference Admin",
            is_staff=True,
            is_superuser=True,
        )
        ...
        self.customer = self.create_test_user(
            phone="+989820000002",
            email="customer_order_pref@example.com",
            full_name="Order Preference Customer",
        )

        self.category = Category.objects.create(
            name="Order Preference Category",
        ...
        self.product = Product.objects.create(
            ...
            name="Order Preference Product",
            description="Product for order preference tests",
            price=Decimal("100000"),
            status=Product.StatusChoices.APPROVED,
            is_active=True,
            sku="ORDER-PREF-SKU-001",
        )

        self.warehouse = Warehouse.objects.create(
            name="Order Preference Warehouse",
            code="ORD-PREF-WH-001",
            ...
            phone="+982100000000",
            email="order-pref-warehouse@example.com",
            manager_name="Warehouse Manager",
            manager_phone="+989820000003",
            is_active=True,
    ...
    def checkout_order(self):
        ...
        response = self.client.post(
            url,
            data={
                "receiver_name": "Order Preference Customer",
                "receiver_phone": "+989820000002",
                "province": "Tehran",
                "city": "Tehran",
    ...
    def assert_order_notification_does_not_exist(self, *, order, title):
        self.assertFalse(
    ...
    def test_muted_order_type_blocks_order_created_notification(self):
    ...
    def test_muted_order_type_blocks_order_cancelled_notification(self):
        order = self.checkout_order()
